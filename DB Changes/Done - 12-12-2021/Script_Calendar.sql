declare @start_dt as date = '1/1/1980';		-- Date from which the calendar table will be created.
declare @end_dt as date = '1/1/3000';		-- Calendar table will be created up to this date (not including).
