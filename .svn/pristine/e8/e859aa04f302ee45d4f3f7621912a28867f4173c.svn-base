...
{
    public partial class ListAnnualProgressReports : Page
    {
        #region Delegates
        ...
        private void LoadReports(int nCurrentPage)
        {
            ...
            DataSet oSqlDataSet = oCommon.LoadStudentAnnualProgressReports(nStudentId, szSrchYearName, nCurrentPage,
        ...
        protected void btnEditReport_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AddAnnualProgressReport.aspx?ReportId=" + szCurReportId);
        }

        protected void btnDetail_Click(object sender, EventArgs e)
        {
            string szCurReportId = hdnReportID.Value;
            Response.Redirect("DetailsAnnualProgressReport.aspx?ReportId=" + szCurReportId);
        }
        ...
        protected void btnDelReport_Click(object sender, EventArgs e)
        {
            ...
            var oCommon = new Common();
            int nStatus = oCommon.DeleteAnnualStudentProgressReport(szCurReportId);
            if (nStatus > 0)
            {
                szStatus = "5031031";
            }

            Response.Redirect("ListAnnualProgressReports.aspx?status=" + szStatus);
        }
