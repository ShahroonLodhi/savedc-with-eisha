    ...
    public partial class AddStudent : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                // dont allow operator to edit except few.
                if (SaveDCSession.UserAccessLevel != UserAccessLevels.Operator ||
                    SaveDCSession.UserName.ToLower() == "shamsa" || SaveDCSession.UserName.ToLower() == "muzaffar" || SaveDCSession.UserName.ToLower() == "irfan")
                {
        ...
        protected void btnUpdate_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (ohistory.HistoryId > 0)
            {
                ...
                oStudent.DateOfBirth = DateTime.ParseExact(txtDOB.Text, @"dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
