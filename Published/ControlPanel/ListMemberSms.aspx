<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="ListMemberSms.aspx.cs" Inherits="SaveDC.ControlPanel.ListMemberSms" Title="List Member SMS"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
            <td class="CellHeading" width="60%">List Sent SMS for <i><%= hdnDonorName.Value %></i></td>
