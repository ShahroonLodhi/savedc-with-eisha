<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"
         CodeBehind="ListEmployee.aspx.cs" Inherits="SaveDC.ControlPanel.ListEmployee"
         Title="List Employee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        <tr>
            <td height="20px" colspan="2" class="CellLabel">
                <table width="100%">
                    <tr>
                        <td width="80%">
                            Employee Manager :: List Employee
                        </td>
        ...
        <tr>
            <td height="20px" colspan="2">This is Employee Manager. Here all of your employee are listed with their brief details like the First Name, Last Name, Phone Number, Email Address, Date of Birth etc.
                If you want to have a detail view of the employee then select the appropriate employee and click on Employee Details button.<br /><br />
                You can also filter specific Employee in the listing through Employee Name.
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td class="CellHeading" width="60%">Employee Manager</td>
            <td class="ContextLinks" align="right">Total Employee:
                    ...
                    <tr>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# ConvertToTitleCase(Eval("EmployeeName").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle Width="9%" />
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "CNIC") %>
                                        </ItemTemplate>
                                        <ItemStyle Width="9%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "DOB" , "{0:dd/MM/yyyy}") %>
                                        </ItemTemplate>
                                        <ItemStyle Width="7%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# ConvertToTitleCase(Eval("Designation").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle Width="8%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# ConvertToTitleCase(Eval("Department").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle Width="7%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                        ...
                        <td valign="top">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnDetail" runat="server" Width="100%" Text="Employee Details" OnClick="btnDetail_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnEditUser" runat="server" Width="100%" Text="Edit Employee" OnClick="btnEditUser_Click" />
                                    </td>
                                </tr>
                                <%--<tr ><td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnDelUser" runat="server" Width="100%" Text="Delete Employee" OnClientClick="return ValidateAction('DELETE');"
