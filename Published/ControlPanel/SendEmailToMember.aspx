<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="SendEmailToMember.aspx.cs" Inherits="SaveDC.ControlPanel.SendEmailToMember" Title="Send Email to Member"%>
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
            ...
            <td class="CellHeading" width="40%">
                Send Email to <i><%= hdnDonorName.Value %></i>
            </td>
        ...
        <tr>
            ...
            <td class="CellData">
                Dear <i><%= hdnDonorName.Value %></i>,<br />
