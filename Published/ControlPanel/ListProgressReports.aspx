<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="ListProgressReports.aspx.cs" Inherits="SaveDC.ControlPanel.ListProgressReports" Title="List Progress Reports"%>
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        <tr>
            <td height="20px" colspan="2"  class="CellLabel" >
                ...
                <table width="100%">
                    <tr>
                        <td width="80%">
                            Student Manager :: List Students :: Student Reports
        ...
        <tr id="trAddReport" runat="server">
            <td height="10px" colspan ="2" align="right">
                [ <a href="AddProgressReport.aspx">Add Progress Report</a> ]
            </td>
        </tr>
	
        <tr>
            <td class="CellHeading" width="60%">Manage Progress Reports for 
                            ...
                            <asp:DataGrid ID="dgReports" runat="server" AutoGenerateColumns="False" Width="100%" SkinID="StanderdGrid" OnItemDataBound="dgReports_Databound" >
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "ReportMonth") %>
                                        </ItemTemplate>
                                        <ItemStyle Width="17%" />
                                    </asp:TemplateColumn>	
                                    <asp:TemplateColumn>
