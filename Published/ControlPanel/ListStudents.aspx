<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="ListStudents.aspx.cs" Inherits="SaveDC.ControlPanel.ListStudents" Title="List Students"%>
                ...
                <table id="Table1" runat="server" border="0" width="100%">
                    <form name="frmsearch" method="post" id="frmsearch">
                        ...
                        <tr>
                            ...
                            <td colspan="2" valign="middle">
                                <asp:DropDownList ID="txtClassLevel" runat="server" />
                            </td>
                        </tr>
                ...
                <table width="100%" border = 0 id="tbDataFound" runat="server">
                    <tr>
                        <td valign="top" width="85%" >
                            ...
                            <asp:DataGrid ID="dgStudents" runat="server" AutoGenerateColumns="False" Width="100%" SkinID="StanderdGrid" OnItemDataBound="dgStudents_Databound" CssClass="mGrid">
                                <Columns>
                                    <asp:TemplateColumn>
                                        <HeaderTemplate>
                                        </HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a onclick="   ShowModel('DetailsFamily.aspx?FamilyId=<%# DataBinder.Eval(Container.DataItem, "FamilyId") %>');" href="javascript:void(0);">	<%# ConvertToTitleCase(Eval("FamilyName").ToString())%> </a>
                                        </ItemTemplate>
                                        <ItemStyle Width="15%" />
                                    </asp:TemplateColumn>		
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a onclick="   ShowModel('DetailsSchool.aspx?SchoolId=<%# DataBinder.Eval(Container.DataItem, "SchoolId") %>');" href="javascript:void(0);">	<%# ConvertToTitleCase(Eval("SchoolName").ToString())%> </a>
                                        </ItemTemplate>
                                        <ItemStyle Width="25%" />
                                    </asp:TemplateColumn>	
                                    <asp:TemplateColumn>
                        ...
                        <td valign="top">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnAtachments" runat="server" Width="100%" Text="Attachments"
