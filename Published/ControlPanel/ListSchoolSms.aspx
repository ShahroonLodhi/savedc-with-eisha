<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="ListSchoolSms.aspx.cs" Inherits="SaveDC.ControlPanel.ListSchoolSms" Title="List School Sms"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        <tr>
            <td height="20px" colspan="2" class="CellLabel" >
                <table width="100%">
                    <tr>
                        <td width="80%">
                            School Manager :: List Schools SMS
        ...
        <tr>
            <td class="CellHeading" width="60%">List Sent SMS for <i><%= hdnSchoolName.Value %></i></td>
            <td class="ContextLinks" align="right">Total Sent SMS: 
                ...
                <table width="100%" border = 0 id="tbDataFound" runat="server">
                    <tr>
                        <td width="85%"  valign="top">
                            ...
                            <asp:HiddenField runat="server" ID="hdnSchoolName" Value ="" />
                            <asp:DataGrid ID="dgSchools" runat="server" AutoGenerateColumns="False" Width="100%" SkinID="StanderdGrid" OnItemDataBound="dgSchools_Databound" >
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "RecipientNum") %>
                                        </ItemTemplate>
                                        <ItemStyle Width="30%" />
                                    </asp:TemplateColumn>	
                                    <asp:TemplateColumn>
