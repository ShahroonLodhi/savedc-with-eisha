<%@ Control Language="C#" AutoEventWireup="true" Inherits="SaveDC.ControlPanel.Controls.AdvDataPager" Codebehind="AdvDataPager.ascx.cs" %>
    ...
    <tr class="GridFooter" style="height: 25px;">
        ...
        <td align="center" style="width: 50%">
            <table cellpadding="0" cellspacing="0" border="0" class="PagingNavigation">
                <tr>
                    <td>
                        <%--                    <asp:LinkButton runat="server" ToolTip="Move First" ID="btnMoveFirst" CssClass="PagingFirst"
                            CommandArgument="First" OnCommand="btnMove_Click" >hjhj</asp:LinkButton>--%>
