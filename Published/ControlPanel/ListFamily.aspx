<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="ListFamily.aspx.cs" Inherits="SaveDC.ControlPanel.ListFamily" Title="List Family"%>
                ...
                <table width="100%" border = 0 id="tbDataFound" runat="server">
                    <tr>
                        <td width="85%"  valign="top">
                            ...
                            <asp:DataGrid ID="dgFamilies" runat="server" AutoGenerateColumns="False" Width="100%" SkinID="StanderdGrid" OnItemDataBound="dgFamilies_Databound" CssClass="mGrid">
                                <Columns>
                                    <asp:TemplateColumn>
                                        <HeaderTemplate>
                                        </HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# ConvertToTitleCase(Eval("DisplayName").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle Width="10%" />
                                    </asp:TemplateColumn>	
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# ConvertToTitleCase(Eval("FatherName").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle Width="10%" />
                                    </asp:TemplateColumn>	
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# ConvertToTitleCase(Eval("MotherName").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle Width="10%" />
                                    </asp:TemplateColumn>	
                                    <asp:TemplateColumn>
