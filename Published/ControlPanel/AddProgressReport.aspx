<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="AddProgressReport.aspx.cs" Inherits="SaveDC.ControlPanel.AddProgressReport" Title="Add Progress Report"%>
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        <tr>
            ...
            <td height="20px" class="CellLabel"  colspan="3">
                Student Manager :: List Students :: Progress Reports :: <%= hdnAddEdit.Value %> Progress Report
            </td>
        </tr>
        <tr>
            <td height="20px">
        ...
        <tr>
            ...
            <td class="CellData" colspan="2">
                ...
                </asp:DropDownList> <i>[Note: Make sure you do not select a month of summer holidays.]</i>
            </td>
        </tr>
        <%--  <tr>
