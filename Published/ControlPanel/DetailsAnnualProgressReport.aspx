<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="DetailsAnnualProgressReport.aspx.cs" Inherits="SaveDC.ControlPanel.DetailsAnnualProgressReport" Title="Annual Progress Report Details"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        <tr>
            <td height="20px" class="CellLabel"  colspan="3">
                ...
                <table width="100%">
                    <tr>
                        <td width="80%">
                            Student Manager :: List Students :: Annual Progress Reports :: Annual Progress Report Details
        ...
        <tr>
            <td class="CellHeading" width="40%">Annual Progress Report Details</td>
