    ...
    public partial class ListUsers : Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                ...
                {
                    ExportToExcel(ds.Tables[0], "Users Report");
                }
            }
        }
        ...
        private void ExportToExcel(DataTable dt, string fileName)
        {
            ...
            try
            {
                if (dt.Rows.Count >= 1)
                {
                    ...
                    dt2.Columns.Remove("LastSMSDate");
                    dt2.Columns["FirstName"].ColumnName = "First Name";
                    dt2.Columns["LastName"].ColumnName = "Last Name";
                    dt2.Columns["PhoneNum"].ColumnName = "Phone #";
                    dt2.Columns["Email"].ColumnName = "Email Address";
                    dt2.Columns["RoleName"].ColumnName = "User Role";

                    dt2.Columns["Phone #"].SetOrdinal(3);
                    dt2.Columns["Email Address"].SetOrdinal(4);
                    dt2.Columns["User Role"].SetOrdinal(5);
        ...
        protected void searchbtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("ListUsers.aspx?UserName=" + szSrchUserName);
        }
        ...
        {
            string szCurUserId = hdnUserID.Value;
            Response.Redirect("DetailUsers.aspx?UserId=" + szCurUserId);
        }
        ...
        protected void btnDelUser_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ListUsers.aspx?status=" + szStatus);
        }

        protected void btnEditUser_Click(object sender, EventArgs e)
        {
            string szCurUserId = hdnUserID.Value;
            Response.Redirect("AddUsers.aspx?UserId=" + szCurUserId);
        }
