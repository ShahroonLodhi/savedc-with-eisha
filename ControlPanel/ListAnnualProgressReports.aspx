<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="ListAnnualProgressReports.aspx.cs" Inherits="SaveDC.ControlPanel.ListAnnualProgressReports" Title="List Annual Progress Reports"%>
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        <tr>
            <td height="20px" colspan="2"  class="CellLabel" >
                ...
                <table width="100%">
                    <tr>
                        <td width="80%">
                            Student Manager :: List Students :: Student Annual Reports
        ...
        <tr id="trAddReport" runat="server">
            <td height="10px" colspan ="2" align="right">
                [ <a href="AddAnnualProgressReport.aspx">Add Annual Progress Report</a> ]
            </td>
        </tr>
	
        <tr>
            <td class="CellHeading" width="60%">Manage Annual Progress Reports for 
                <asp:Label ID="lblStdName" style="font-style: italic" runat="server" Text=""></asp:Label></td>
            <td class="ContextLinks" align="right">Total Reports: 
                ...
                <table width="100%" border = 0 id="tbDataFound" runat="server">
                    <tr>
                            ...
                            <asp:DataGrid ID="dgReports" runat="server" AutoGenerateColumns="False" Width="100%" SkinID="StanderdGrid" OnItemDataBound="dgReports_Databound" >
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "ReportYear") %>
                                        </ItemTemplate>
                                        <ItemStyle Width="17%" />
                                    </asp:TemplateColumn>	
                                    <asp:TemplateColumn>
                        ...
                        <td valign="top">
                            <table >
                                <tr><td >
                                        <asp:Button ID="btnDetail" runat="server"  Width="100%" Text="Report Details" OnClick="btnDetail_Click" />
                                    </td></tr>
                                <tr ><td>
                                         <asp:Button ID="btnEditReport" runat="server" Width="100%" Text="Edit Report" OnClick="btnEditReport_Click" />
                                     </td></tr>
                                <tr><td>
                                        <asp:Button ID="btnDelReport" runat="server"  Width="100%" Text="Delete Report"  OnClick="btnDelReport_Click" 
