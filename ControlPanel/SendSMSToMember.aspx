<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="SendSMSToMember.aspx.cs" Inherits="SaveDC.ControlPanel.SendSMSToMember" Title="Send SMS to Member"%>
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
            ...
            <td class="CellHeading" width="40%">
                Send SMS to <i><%= hdnDonorName.Value %></i>
            </td>
