...
{
    public partial class DetailsMonthlyExpense : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (ExpenseId > 0)
                {
                    ...
                    lblPostedBy.Text = expenseDetails.PostedByName;
                    ...
                    if (expenseDetails.ExpenseType == "1")
                    {
                        ...
                        Repeater1.DataSource = oCommon.SchoolExpenseStudents(ExpenseId, expenseDetails.SchoolId);
