<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="GetSchoolDonationReport.aspx.cs" Inherits="SaveDC.ControlPanel.GetSchoolDonationReport" Title="Get School Donation Report"%>
<%@ Register Src="Controls/AdvDataPager.ascx" TagName="DataPager" TagPrefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <head>
        <title>Get School Donation Report</title>
        <style>
            .mGrid td {   
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        <tr>
            <td height="20px" colspan="2"  class="CellLabel" >
                ...
                <table width="100%">
                    <tr>
                        <td width="80%">
                            Reports :: Monthly Donation Report
        ...
        <tr>
            <td colspan="2" height="10px" align="right">
                [ <a href="GetDonationReport.aspx">General Donation Report</a> ] [ <font color="gray">Monthly Donation Report</font> ] [ <a href="GetExpenseReport.aspx">General Expense Report</a> ] [ <a href ="GetSchoolExpenseReport.aspx">Monthly Expense Report</a> ] [ <a href="GetSMSReport.aspx">SMS Report</a> ] 
            </td>
        </tr>
        <tr>
                            ...
                            <asp:DataGrid ID="dgSchools" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "DonationMonth") %>
                                        </ItemTemplate>
                                        <ItemStyle Width="25%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%--<%# DataBinder.Eval(Container.DataItem, "DonationAmount") %>--%>
                                            <%# ConvertAmounToPkrCurrency(Eval("DonationAmount")) %>
                                        </ItemTemplate>
                                        <ItemStyle Width="25%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <a href="GetSchoolDonationReportDetail.aspx?DonMonth=<%# DataBinder.Eval(Container.DataItem, "DonationMonth") %>">View Details</a>
                                        </ItemTemplate>
                                        <ItemStyle Width="25%" />
                                    </asp:TemplateColumn>
                                </Columns>
