<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="AddUsers.aspx.cs" Inherits="SaveDC.ControlPanel.AddUsers" Title="Add User"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link type="text/css" href="../js/css/ui-lightness/jquery-ui-1.8.18.custom.css" rel="stylesheet" />	    <script type="text/javascript" src="../js/jquery-1.7.1.min.js"> </script>    <script type="text/javascript" src="../js/jquery-ui-1.8.18.custom.min.js"> </script>    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function() {
            $("#<%= txtRD.ClientID %>").datepicker({
                changeMonth: true,
                changeYear: true,
                dateFormat: 'dd/mm/yy',
                yearRange: "-50:+0"
            });
            $("#<%= txtRD.ClientID %>").datepicker("option", "showAnim", "slideDown");
        });
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr runat="server" id="loginRow2" visible="true">
            ...
            <td class="CellData">
                <asp:PlaceHolder ID="PlaceHolder1" runat="server">
                    <asp:TextBox CssClass="Textbox" ID="txtUserName" runat="server" Columns="50"/>
                    <asp:RequiredFieldValidator ID="RFV_txtUserName" runat="server" ControlToValidate="txtUserName"
                                                ErrorMessage="Please enter a valid Username."></asp:RequiredFieldValidator></asp:PlaceHolder></td>
        </tr> 
        <tr runat="server" id="loginRow3" visible="true"> 
            <td class="CellLabel">Password : </td>
            <td class="CellData" ><asp:TextBox CssClass="Textbox" ID="txtUserpassword" 
                                               runat="server"  TextMode="Password"/>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtUserpassword"
        ...
        <tr id="trGender" runat="server" visible="false"> 
            ...
            <td class="CellData"><asp:RadioButton Checked ID="txtGenderM" GroupName="Gender" runat="server" Text="Male"/>
        ...
        <tr id="trCNIC" runat="server" visible="false"> 
            ...
            <td class="CellData"><asp:TextBox CssClass="Textbox" ID="txtCNIC" runat="server" Columns="50"/></td>
        </tr>
        <tr id="trOccupation" runat="server" visible="false"> 
            <td class="CellLabel">Occupation : </td>
            <td class="CellData"><asp:TextBox CssClass="Textbox" ID="txtOccupation" runat="server" Columns="50"/></td>
        </tr>
        <tr id="trQualification" runat="server" visible="false"> 
            <td class="CellLabel">Qualification : </td>
            <td class="CellData"><asp:TextBox CssClass="Textbox" ID="txtQualification" runat="server" Columns="50"/></td>
        </tr>
        <tr> 
