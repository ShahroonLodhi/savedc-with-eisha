...
{
    public partial class GetSchoolExpenseReport : Page
    {
        #region Delegates
        ...
        {
            if (Session["MonthlyExpenseReport"] != null)
            {
                DataSet ds = Session["MonthlyExpenseReport"] as DataSet;
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ExportToExcel(ds.Tables[0], "Monthly Expense Report");
                    }
                }
            }
        }
        ...
        private void ExportToExcel(DataTable dt, string fileName)
        {
            ...
            try
            {
                if (dt.Rows.Count >= 1)
                {
                    ...
                    dt2.Columns["ExpenseMonth"].ColumnName = "Expense Month";
                    dt2.Columns["ExpenseAmount"].ColumnName = "Total Amount";
        ...
        private void GetReport(int nCurrentPage)
        {
            ...
            DataSet report = oCommon.GetSchoolExpenseReport(nCurrentPage, pagerApps.RecordsPerPage, szActionDate,
                                                            out nTotalRecord);
            Session["MonthlyExpenseReport"] = report;
            //===============================================================
        ...
        protected void searchbtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("GetSchoolExpenseReport.aspx?ActionDate=" + szSrchDate);
        }
    }
}