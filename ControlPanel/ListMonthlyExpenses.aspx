<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="ListMonthlyExpenses.aspx.cs" Inherits="SaveDC.ControlPanel.ListMonthlyExpenses" Title="List Monthly Expenses"%>
...
//     SelectFirst('dgExpenses');
    ...
    <head>
        <title>List Monthly Expenses</title>
        <style>
            .mGrid td+td {   
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr id="ExpensesGridLabel" runat="server">
        ...
        <tr id="expensesgrid" runat="server">
                    ...
                    <tr>
                        <td width="85%"  valign="top">
                            <asp:DataGrid ID="dgExpenses" runat="server" AutoGenerateColumns="False" Width="100%"
                                          SkinID="StanderdGrid" OnItemDataBound="dgExpenses_Databound" CssClass="mGrid">
                                <Columns>
                                    <asp:TemplateColumn>
                                        <HeaderTemplate>
                                        </HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%# ConvertToTitleCase(Eval("ExpensePayee").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle Width="20%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "eType")%>
                                        </ItemTemplate>
                                        <ItemStyle Width="12%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "BankName").ToString().Substring(0, 16) %>
                                        </ItemTemplate>
                                        <ItemStyle Width="12%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
