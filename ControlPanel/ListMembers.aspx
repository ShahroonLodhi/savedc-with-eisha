<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"
         CodeBehind="ListMembers.aspx.cs" Inherits="SaveDC.ControlPanel.ListMembers"
         Title="List Members" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
            <td height="20px" colspan="2">This is Members Area. Here all of your members are listed with their brief details like the First Name, Last Name, Phone Number and Email Address.
                If you want to have a detail view of the member then select the appropriate member and click on Member Details button.<br /><br />
                You can also filter specific member in the listing through Member Name.
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2" height="10px" align="right">
                [ <a href="SendEmailToMember.aspx">Send Email to all Members</a> ] | [ <a href="AddUsers.aspx?Role=member">Add Member</a> ]
                <asp:LinkButton runat="server" OnClick="btnExportToExcel_Click" Style="color:black">[ Export To Excel ]</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td class="CellHeading" width="60%">Members Area</td>
            <td class="ContextLinks" align="right">Total Members:
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnDetail" runat="server" Width="100%" Text="Members Details" OnClick="btnDetail_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnEditUser" runat="server" Width="100%" Text="Edit Member" OnClick="btnEditUser_Click" />
                                    </td>
                                </tr>
                                <tr ><td>
                                ...
                                <tr ><td>
                                         <asp:Button ID="btnAddFee" runat="server" Width="100%" Text="Add Annual Fee" OnClick="btnAddFee_Click" />
                                     </td></tr>
                                <tr ><td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnDelUser" runat="server" Width="100%" Text="Delete Member" OnClientClick="return ValidateAction('DELETE');"
