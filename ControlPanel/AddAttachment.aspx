<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"  CodeBehind="AddAttachment.aspx.cs" Inherits="SaveDC.ControlPanel.AddAttachment" Title="Add Attachment"%>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function StartupScriptReports() {
            ...
            if (ReportNewVal) {
                ...
                document.getElementById('viewlink1').setAttribute("onclick", ViewHTML.replace("_REPLACEURL", '../Uploads/Attachments/' + ReportNewVal + '.jpg'));
            } else {
                document.getElementById('browseReport').style.display = '';
                document.getElementById('viewReport').style.display = 'none';
            }
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        <tr>
            ...
            <td height="20px" class="CellLabel"  colspan="3">
                Student Manager :: List Students :: <%= hdnAddEdit.Value %> Attachment
            </td>
        </tr>
        <tr>
            <td height="20px">
        ...
        <tr>
            ...
            <td class="CellHeading" width="40%"><%= hdnAddEdit.Value %> Attachment for <asp:Label ID="lblStdName" runat="server"  style="font-style: italic"  Text="Label"></asp:Label></td>
        ...
        <tr>
            ...
            <td class="CellData" colspan="2">
                <asp:PlaceHolder ID="PlaceHolder1" runat="server">
                    ...
                    <span id="viewReport" ><a href="javascript:void(0);"  id="viewlink1">View Attachment</a> | <a
                                                                                                               href="#" onclick=" RemoveReport(); return false; ">Remove Attachment</a> </span>
