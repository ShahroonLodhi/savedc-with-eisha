<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/CPMaster.Master" AutoEventWireup="true"
         CodeBehind="ListDonors.aspx.cs" Inherits="SaveDC.ControlPanel.ListDonors"
         Title="List Donors" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="95%" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>
            <td height="20px" colspan="2">This is Donor Manager. Here all of your donors operating this system are listed with their brief details like the First Name, Last Name, Phone Number and Email Address.
                If you want to have a detail view of the donor then select the appropriate donor and click on Donor Details button.<br /><br />
                You can also filter specific donor in the listing through Donor Name.
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2" height="10px" align="right">
                [ <a href="AddNotesForDonor.aspx">Add Note for all Donors</a> ] | [ <a href="SendEmailToDonor.aspx">Send Email to all Donors</a> ] | [ <a href="AddUsers.aspx?Role=donor">Add Donor</a> ]
                <asp:LinkButton runat="server" OnClick="btnExportToExcel_Click" Style="color:black">[ Export To Excel ]</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td class="CellHeading" width="60%">Donor Manager</td>
            <td class="ContextLinks" align="right">Total Donors:
                    ...
                    <tr>
                            ...
                            <asp:DataGrid ID="dgUsers" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%--<a href="login.aspx?autologin=<%# DataBinder.Eval(Container.DataItem, "UserID") %>"><%# DataBinder.Eval(Container.DataItem, "UserName") %></a>--%>
                                            <a href="login.aspx?autologin=<%# DataBinder.Eval(Container.DataItem, "UserID") %>"><%# ConvertToTitleCase(Eval("UserName").ToString())%></a>
                                        </ItemTemplate>
                                        <ItemStyle Width="8%" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn>
                                        ...
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "LastSMSDate") %>
                                        </ItemTemplate>
                                        <ItemStyle Width="15%" />
                                    </asp:TemplateColumn>
                        ...
                        <td valign="top">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnDetail" runat="server" Width="100%" Text="Donor Details" OnClick="btnDetail_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnEditUser" runat="server" Width="100%" Text="Edit Donor" OnClick="btnEditUser_Click" />
                                    </td>
                                </tr>
                                <tr ><td>
                                         <asp:Button ID="btnAddRemarks" runat="server" Width="100%" Text="Add Remarks" OnClick="btnAddRemarks_Click" />
                                     </td></tr>
                                <tr ><td>
                                         <asp:Button ID="btnAddNotes" runat="server" Width="100%" Text="Add Note" OnClick="btnAddNotes_Click" />
                                     </td></tr>
                                <tr ><td>
                                         <asp:Button ID="btnSendEmail" runat="server" Width="100%" Text="Send Email" OnClick="btnSendEmail_Click" />
                                     </td></tr>
                                <tr ><td>
                                         <asp:Button ID="btnEmailHistory" runat="server" Width="100%" Text="Email History" OnClick="btnEmailHistory_Click" />
                                     </td></tr>
                                <tr ><td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnDelUser" runat="server" Width="100%" Text="Delete Donor" OnClientClick="return ValidateAction('DELETE');"
