...
{
    public partial class ListProgressReports : Page
    {
        #region Delegates
        ...
        private void LoadReports(int nCurrentPage)
        {
            ...
            {
                szSrchMonthName = Request.QueryString["MonthName"];
                txtMonthName.Text = szSrchMonthName;
            }
            ...
            // oCommon.GetSchoolNameById(oStudent.SchoolId);

            Int32 nTotalRecord = 0;
            DataSet oSqlDataSet = oCommon.LoadStudentProgressReports(nStudentId, szSrchMonthName, nCurrentPage,
        ...
        protected void btnEditReport_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AddProgressReport.aspx?ReportId=" + szCurReportId);
        }

        protected void btnDetail_Click(object sender, EventArgs e)
        {
            string szCurReportId = hdnReportID.Value;
            Response.Redirect("DetailsProgressReport.aspx?ReportId=" + szCurReportId);
        }
        ...
        protected void btnDelReport_Click(object sender, EventArgs e)
        {
            ...
            string szStatus = "5031030";
            var oCommon = new Common();
            int nStatus = oCommon.DeleteStudentProgressReport(szCurReportId);
            if (nStatus > 0)
            {
                szStatus = "5031031";
            }

            Response.Redirect("ListProgressReports.aspx?status=" + szStatus);
        }
        ...
        protected void searchbtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("ListProgressReports.aspx?MonthName=" + szSrchMonthName);
        }
    }
}