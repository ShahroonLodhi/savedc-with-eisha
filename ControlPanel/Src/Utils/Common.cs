...
namespace SaveDC.ControlPanel.Src.Utils
{
    public class Common
    {
        ...
        public DataSet GetCalandarYear(int MinYear, int MaxYear)
        {
            var dbmanager = new DBManager();
            ...
            try
            {
                SqlParameter[] sqlparameter = {
                                                  dbmanager.makeInParam("@MinDate", SqlDbType.Int, 0, MinYear),
                                                  dbmanager.makeInParam("@MaxDate", SqlDbType.Int, 0, MaxYear)
                                              };

                dataSet = dbmanager.GetDataSetProc("[dbo].[prGetCalendarYear]", sqlparameter);
        ...
        internal Int32 GetDonorsBalance(int nDonorId)
        {
            try
            {
                var dbmanager = new DBManager();
                ...
                SqlDataReader reader = dbmanager.GetDataReaderProc("GetDonorsBalance", parameters);

                if (reader.Read())
                    return Utils.fixNullInt(reader["DonorsBalance"].ToString());
                else
                    return 0;
            }
            catch (Exception e)
        ...
        internal SqlDataReader GetExpenseTypes()
        {
            try
            {
                var dbmanager = new DBManager();
                SqlParameter[] parameters = { };
                return dbmanager.GetDataReaderProc("GetExpenseTypes", parameters);
            }
            catch (Exception e)
            {
                Utils.LogErrorToFile(e);
        ...
        internal SqlDataReader GetEmployees()
        {
            try
            {
                var dbmanager = new DBManager();
                SqlParameter[] parameters = { };
                return dbmanager.GetDataReaderProc("GetEmployees", parameters);
            }
            catch (Exception e)
            {
                Utils.LogErrorToFile(e);
        ...
        internal SqlDataReader GetUtilities()
        {
            try
            {
                var dbmanager = new DBManager();
                SqlParameter[] parameters = { };
                return dbmanager.GetDataReaderProc("GetUtilities", parameters);
            }
            catch (Exception e)
            {
                Utils.LogErrorToFile(e);
        ...
        internal Expense GetExpenseDetails(int ExpenseId)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    expenseDetails.ExpenseName = Utils.fixNullString(reader["ExpenseName"].ToString());
        ...
        {
            if (EmailConfiguration.SendReminders)
            {
                try
                {
                    var dbmanager = new DBManager();
                    ...
                    while (oReminderDonors.Read())
                    {
                        ...
                        if (EmailSender.SendEmail(EmailConfiguration.FromAddressInfo, Convert.ToInt32(szDonorId), new Email
                                                      {
            ...
            try
            {
                ...
                else
                {
                    dbmanager.ExecuteNonQuery(
                        "Update tblStudents set StatusId = 6 where StudentId =" +
                        szCurStudentId);

                    dbmanager.ExecuteNonQuery(
                        "UPDATE tsd SET tsd.EstimatedAmount = 0.00 from tblSchoolEstimationDetails tsd INNER JOIN tblSchoolEstimations tse ON tse.EstimationID = tsd.EstimationId WHERE tse.StudentId =" +
                        szCurStudentId);
                }
            }
            catch (Exception e)
        ...
        public DataTable GetSentEmails(int recipientId, int nPageNo, int nPageSize,
                                    string szActionDate,
                                    out int nTotalRecord)
        {
            try
            {
                var dbmanager = new DBManager();
                SqlParameter[] parameters = {
                                                dbmanager.makeInParam("@UserId", SqlDbType.Int, 0, recipientId),
                                                dbmanager.makeInParam("@PageNo", SqlDbType.Int, 0, nPageNo),
                                                dbmanager.makeInParam("@PageSize", SqlDbType.Int, 0, nPageSize),
                                                dbmanager.makeInParam("@DateSent", SqlDbType.NVarChar, 50,
                                                                      szActionDate),
                                                dbmanager.makeOutParam("@TotalRecord", SqlDbType.Int, 4)
                                            };
                DataTable ds = dbmanager.GetDataSetProc("GetSentEmails", parameters).Tables[0];
                nTotalRecord = Utils.fixNullInt(parameters[4].Value);
                return ds;
            }
            catch (Exception e)
        ...
        public DataTable GetDonorsRemarks(int DonorId)
        {
            try
            {
                var dbmanager = new DBManager();
                ...
                DataTable ds = dbmanager.GetDataSetProc("GetDonorsRemarks", parameters).Tables[0];
                return ds;
            }
            catch (Exception e)
            {
        ...
        public DataTable GetMembersFees(int MemberId)
        {
            try
            {
                var dbmanager = new DBManager();
                SqlParameter[] parameters = {
                                                dbmanager.makeInParam("@MemberId", SqlDbType.Int, 0, MemberId)
                                            };
                DataTable ds = dbmanager.GetDataSetProc("GetMembersFees", parameters).Tables[0];
                return ds;
            }
            catch (Exception e)
            {
        ...
        public DataTable GetDonorsNotes(int DonorId)
        {
            try
            {
                var dbmanager = new DBManager();
                ...
                DataTable ds = dbmanager.GetDataSetProc("GetDonorsNotes", parameters).Tables[0];
                return ds;
            }
            catch (Exception e)
            {
        ...
        internal DataSet LoadStudentAttachments(int nStudentId, int nPageNo,
                                                          int nPageSize, out int nTotalRecord)
        {
            try
            {
                ...
                DataSet ds = dbmanager.GetDataSetProc("LoadStudentLeavingCertificate", parameters);
                nTotalRecord = Utils.fixNullInt(parameters[3].Value);
                return ds;
            }
            catch (Exception e)
        ...
        internal int DeleteStudentAttachment(string szCurReportId)
        {
            try
            {
                var dbmanager = new DBManager();
                ...
                return dbmanager.RunProc("DeleteStudentAttachment", parameters);
            }
            catch (Exception e)
            {
                Utils.LogErrorToFile(e);
        ...
        internal void GetStudentAttachmentDetail(int nReportId, ref string szNote,
                                                    ref string ReportGUID, ref string szAddedBy)
        {
            try
            {
                var dbmanager = new DBManager();
                ...
                SqlDataReader reader = dbmanager.GetDataReaderProc("GetStudentLeavingCertificateDetail", parameters);
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
        ...
        internal int AddStudentAttachment(int nEditReportId, int nStudentId, string szNotes,
                                                    string szReportGUID, int AddedBy)
        {
            try
            {
                ...
                return dbmanager.RunProc("AddStudentLeavingCertificate", parameters);
            }
            catch (Exception e)
            {
                Utils.LogErrorToFile(e);
                                                             ...
                                                             int nPageSize, out int nTotalRecord)
        {
            try
            {
                ...
                {
                    if (ds.Tables[0].Rows[intCount][5].ToString() != "")
                    {
                        ds.Tables[0].Rows[intCount][5] = "/Uploads/Attachments/" + ds.Tables[0].Rows[0][5] + ".jpg";
                    }
                }
        ...
        public DataTable GetAllApplicationsForExcel()
        {
            try
            {
                var dbmanager = new DBManager();
                DataSet ds = dbmanager.GetDataSetProc("GetApplicationsForExcelReport");
