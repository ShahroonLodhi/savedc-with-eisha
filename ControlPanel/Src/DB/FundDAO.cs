                ...
                if (data != null)
                {
                    ...
                    if (data.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < data.Tables[0].Rows.Count; i++)
                        {
                            ...
                            funds[i].Attachment = (Utils.Utils.fixNullString(row["AttachGUID"]) == "")? "" : SaveDCConstants.CertificateUploadPath + Utils.Utils.fixNullString(row["AttachGUID"]) + ".jpg";
        ...
        public DataSet GetFundsInDS()
        {
            ...
            try
            {
                SqlParameter[] parameters = {
                                                ...
                                                dbmanager.makeInParam("@FundPostedBy", SqlDbType.Int, 0,
                                                                      fund.FundPostedBy),
                                                dbmanager.makeInParam("@PageNo", SqlDbType.Int, 0, 0),
                                                dbmanager.makeInParam("@PageSize", SqlDbType.Int, 0, 0),
                                                dbmanager.makeOutParam("@TotalRecord", SqlDbType.Int, 4)
                                            };
                ds = dbmanager.GetDataSetProc("GetFundsList", parameters);
                if (ds != null)
                {
                    return ds;
                }
        ...
        public Fund LoadFund(int fundID)
        {
            try
            {
                ...
                if (sqldatareader.Read())
                {
                    ...
                    fund.Attachment = Utils.Utils.fixNullString(sqldatareader.GetValue(sqldatareader.GetOrdinal("AttachGUID")));
                    fund.FundPostedName =
        ...
        public int AddFund()
        {
            ...
            try
            {
                SqlParameter[] parameters = {
                                                ...
                                                dbmanager.makeInParam("@AttachGUID", SqlDbType.NVarChar, 50,
                                                                      fund.Attachment)
                                            };
