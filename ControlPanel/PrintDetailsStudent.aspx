<%@ Page Language="C#" Theme="Default" MasterPageFile="~/ControlPanel/Dummy.Master" CodeBehind="PrintDetailsStudent.aspx.cs"
         Inherits="SaveDC.ControlPanel.PrintDetailsStudent" Title="Student Details" %>
        ...
        <asp:PlaceHolder ID="panPrintable" runat="server">
            <tr>
                ...
                <td class="ContextLinks" colspan="3" align="right">
                    <asp:ImageButton ID="ImageButton2" AlternateText="Print" ToolTip="Click to print and once done; close the form." runat="server"
                                     SkinID="sknImgPrint" Height="24" Width="24" OnClientClick="javascript:window.print();"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td rowspan="5" width="190px">
                    <table cellpadding='0' cellspacing='0' border="1" width='100%' style='margin-bottom: 10px;'>
                        <tr>
