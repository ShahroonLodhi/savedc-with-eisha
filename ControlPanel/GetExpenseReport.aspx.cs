...
namespace SaveDC.ControlPanel
{
    public partial class GetExpenseReport : Page
    {
        ...
        {
            if (Session["GeneralExpenseReport"] != null)
            {
                DataSet ds = Session["GeneralExpenseReport"] as DataSet;
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ExportToExcel(ds.Tables[0], "General Expense Report");
                    }
                }
            }
        }
        ...
        private void ExportToExcel(DataTable dt, string fileName)
        {
            ...
            try
            {
                if (dt.Rows.Count >= 1)
                {
                    ...
                    dt2.Columns["PayeeName"].ColumnName = "Payee Name";
        ...
        private void GetReport(int nCurrentPage)
        {
            ...
            DataSet report = oCommon.GetExpenseReport(szSchoolName, nCurrentPage, pagerApps.RecordsPerPage,
                                                      out nTotalRecord);
            Session["GeneralExpenseReport"] = report;
            //===============================================================
